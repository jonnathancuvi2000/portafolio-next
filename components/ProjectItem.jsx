...
const ProjectItem = ({ title, projectType, backgroundImg, projectUrl, pageData }) => {
  return (
    ...
    <div className='relative flex items-center justify-center h-auto sm:w-[500px] m-auto shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]'>
