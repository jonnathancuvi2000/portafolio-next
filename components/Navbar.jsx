  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        <Link href='/'>
          <Image src="/../public/assets/logojc2.png" alt='/' width='80' height='50' />
        </Link>
        <div>
          <ul 
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
        <div className={nav
          ? 'md:hidden fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500 overflow-auto'
          : 'fixed left-[-100%] top-0 p-10 ease-in duration-500 overflow-auto'}>
          <div>
            <div className='flex w-full items-center justify-between'>
              <Link href='/'>
                <Image src='/../public/assets/logojc2.png' width='45' height='35' alt='' />
              </Link>
            ...
            <div className='border-b border-gray-300 my-4'>
              <p className='w-[85%] md:w-[90%] py-4'>Ingeniero en Sistemas - Desarrolador de Software</p>
            </div>
          </div>
          <div className='py-4 flex flex-col'>
            <ul className='uppercase'>
              ...
              <Link href='/#about'>
                <li onClick={() => setNav(false)} className='py-4 text-sm'>Acerca</li>
              </Link>
              <Link href='/#skills'>
              ...
              <Link href='/#contact'>
                <li onClick={() => setNav(false)} className='py-4 text-sm'>Contactar</li>
              </Link>
            </ul>
            <div className='pt-40'>
